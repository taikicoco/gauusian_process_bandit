...
PARAMS = {
    ...
    'gp_me_list': [0, 0.5],
    'gp_noise_list': np.round(np.geomspace(0.01, 0.5, 2), decimals=2).tolist(),
    'rbf_alpha_list': np.round(np.geomspace(0.01, 0.5, 2), decimals=2).tolist(),
    'rbf_beta_list': np.round(np.geomspace(0.01, 0.5, 2), decimals=2).tolist()
}
